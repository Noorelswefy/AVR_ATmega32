...
u8 KEYPAD_u8GetPressedKey(void)
{
	...
	for(Local_u8ColumnIndex=0; Local_u8ColumnIndex<COLUMNS_NUMBER; Local_u8ColumnIndex++)
	{
		...
		DIO_u8SetPinValue(KEYPAD_u8_COL_PORT, Local_u8ColumnsPinsArr[Local_u8ColumnIndex], DIO_u8_PIN_LOW);

		for(Local_u8RowIndex=0; Local_u8RowIndex<ROWS_NUMBER; Local_u8RowIndex++)
		{
			/*Read the current row*/
			DIO_u8GetPinValue(KEYPAD_u8_ROW_PORT,Local_u8RowsPinsArr[Local_u8RowIndex], &Local_u8PinState);
			...
			DIO_u8SetPinValue(KEYPAD_u8_COL_PORT, Local_u8ColumnsPinsArr[Local_u8ColumnIndex], DIO_u8_PIN_HIGH);
	}
	return Local_u8PressedKey;
}
